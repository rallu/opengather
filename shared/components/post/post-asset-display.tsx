...
function collectAlbumTags(assets: SharedPostAsset[]): string[] {
...
export function PostAssetDisplay(props: {
	...
	return (
		<PostVideoContent
			src={firstAsset.variants.playback ?? undefined}
			posterSrc={
				firstAsset.variants.poster ?? firstAsset.variants.thumbnail ?? undefined
			}
			title={firstAsset.alt ?? undefined}
