...
export type NotificationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "kind" | "title" | "body" | "targetUrl" | "relatedEntityId" | "payload" | "readAt" | "createdAt", ExtArgs["result"]["notification"]>
