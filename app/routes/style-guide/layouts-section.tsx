						...
						<CenteredLayout className="space-y-4">
							<Card>
								<CardContent className="space-y-3 pt-6">
									...
									>
										<p>
											A centered layout keeps the reading column stable and lets
											the content carry the page without extra side structure.
										</p>
									</PostContent>
								</CardContent>
							</Card>
							<Card>
								<CardContent className="pt-6">
									<p className="text-sm leading-7 text-muted-foreground">
										Additional feed cards stack in the same width, keeping the
										rhythm consistent down the page.
									</p>
								</CardContent>
							</Card>
						</CenteredLayout>
					...
					<CardContent className="pt-6">
						<RightSidebarLayout>
							...
							<LayoutSidebar className="space-y-3">
								<Card>
									<CardContent className="pt-6">
										<PostComments comments={sampleComments.slice(0, 2)} />
									</CardContent>
								</Card>
							</LayoutSidebar>
						</RightSidebarLayout>
