						...
						{[
							...
							>
								...
								<div className="space-y-1">
									...
									<p className="text-xs text-muted-foreground">{token.text}</p>
								</div>
							</div>
						))}
					</CardContent>
				...
				<Card>
					<CardContent className="space-y-4 pt-6">
						<div className="rounded-lg border border-border p-4">
							<p className="text-sm text-muted-foreground">Sans family</p>
			...
			>
				...
				<Card>
					<CardContent className="space-y-4 pt-6">
						...
						<div className="space-y-2">
							<p className="text-sm font-medium text-muted-foreground">H4</p>
				...
				<Card>
					<CardContent className="space-y-4 pt-6">
						<p className="max-w-3xl text-base leading-7 text-foreground">
							Body text in OpenGather should read clearly on both dense product
							screens and longer content surfaces. It should feel stable and
					...
					<CardContent className="space-y-4 pt-6">
						<div className="flex items-end gap-4">
							{[
								...
								<div key={space.label} className="space-y-2 text-center">
									<div
										className={`rounded-sm bg-primary/12 ${space.className}`}
									/>
									<p className="text-xs text-muted-foreground">{space.label}</p>
								</div>
							))}
						</div>
					</CardContent>
