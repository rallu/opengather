				...
				>
					...
					<div className="rounded-xl border border-border/70 p-4">
						<p className="text-sm leading-7 text-foreground">
							Use the same container around post cards, side menus, and composer
							shells so the surface language stays consistent.
						</p>
					</div>
				</Container>
			</section>
			<section className="space-y-4" data-testid="style-guide-card">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Cards provide a reliable header-content-footer structure for
							future product surfaces.
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-3">
						<p className="text-sm leading-7 text-muted-foreground">
							Use cards when a block needs clear hierarchy, breathing room, and
							a consistent border/surface treatment.
						</p>
						<div className="grid gap-3 sm:grid-cols-3">
							...
							<div className="rounded-lg bg-muted/50 p-3 text-sm">
								...
								<p className="mt-1 text-muted-foreground">14 public spaces</p>
							</div>
							<div className="rounded-lg bg-muted/50 p-3 text-sm">
								<p className="font-medium">Moderation</p>
								<p className="mt-1 text-muted-foreground">Healthy baseline</p>
							</div>
						</div>
					</CardContent>
					<CardFooter>
				...
				<div className="grid gap-4 lg:grid-cols-3">
					<div className="elevation-low rounded-lg border border-border bg-card p-4">
						...
						<p className="mt-2 text-sm text-muted-foreground">
							Default for cards, bubbles, navigation, and everyday surfaces.
						</p>
					</div>
					<div className="elevation-medium rounded-lg border border-border bg-card p-4">
						...
						<p className="mt-2 text-sm text-muted-foreground">
							Use sparingly for feature surfaces such as heroes or highlighted
							content.
						</p>
					</div>
					<div className="elevation-high rounded-lg border border-border bg-card p-4">
						...
						<p className="mt-2 text-sm text-muted-foreground">
							Reserve for overlays, urgent layers, or future modal-level UI.
						</p>
					</div>
				</div>
			</section>
